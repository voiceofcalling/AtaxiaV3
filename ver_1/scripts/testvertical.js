...
switch(getParameterByName("test")){
	...
	case "diagonal2":
		...
		coordHandler = function(w, h){
			return [[w - 60, 10, 50, 50], [10, h - 60, 50, 50]];
		};
		break;
}
...
function reset() {
    ...
    var dx = rightObjective[0]-leftObjective[0];
    var dy = rightObjective[1]-rightObjective[1];
    starttheta = Math.atan2(dx,dy);
    cartesianToPolar(dx,dy);
